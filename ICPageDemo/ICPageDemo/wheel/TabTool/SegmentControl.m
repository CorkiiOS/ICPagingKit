...
@property (nonatomic, strong) ICTabToolStyleModel *config;
...
- (void)updateWithConfig:(void (^)(ICTabToolStyleModel *))bloIC {
...
- (void)setDelegate:(id<ICTabToolProtocol>)delegate {
...
- (ICTabToolStyleModel *)config {
    
    if (_config == nil) {
        
        _config = [ICTabToolStyleModel defultCongfig];
    }
